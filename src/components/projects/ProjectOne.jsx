/* eslint-disable react-hooks/set-state-in-effect -- material state mirrors Three.js objects. */
/*
...
export function ProjectOne(props) {
  ...
  useEffect(() => {
    if (doorRef.current && materials.door_m) {
    ...
    if (windowRef.current && materials.window_big_m) {
    ...
    if (wallsRef.current && materials["walls.png"]) {
    ...
    if (roofRef.current && materials["roof.png"]) {
